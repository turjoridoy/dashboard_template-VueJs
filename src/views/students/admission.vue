...
const isStepValid = (step) => {
  switch(step) {
    case 1:
      return formData.value.studentName && formData.value.dateOfAdmission && formData.value.selectClass && formData.value.discountInFee;
    case 2:
            ...
            >
              ...
              <div class="mt-3 text-center">
                <span class="text-xs font-semibold block"
                  ...
                  {{ step === 1 ? 'Student Info' : step === 2 ? 'Additional Info' : step === 3 ? 'Father Info' : 'Mother Info' }}
                </span>
                <span class="text-xs text-gray-400 mt-1 block">
                  {{ step === 1 ? 'Basic details' : step === 2 ? 'Personal info' : step === 3 ? 'Guardian details' : 'Parent info' }}
                </span>
              </div>
            </div>
          </div>
          ...
          <form @submit.prevent="submitForm">
            ...
            <div v-show="currentStep === 1" class="p-8">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                  <label class="block text-sm font-semibold text-gray-700">
                    Fee Discount <span class="text-red-500">*</span>
                  </label>
                  <div class="relative">
                    <input
                      v-model="formData.discountInFee"
                      type="number"
            ...
            <div v-show="currentStep === 2" class="p-8">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                  ...
                  <input
                    v-model="formData.studentBirthFormId"
                    type="text"
            ...
            <div v-show="currentStep === 3" class="p-8">
              <div class="flex items-center mb-8">
                ...
                <div>
                  <h2 class="text-2xl font-bold text-gray-800 mb-1">Father/Guardian Information</h2>
                  <p class="text-gray-500 text-sm">Details about the student's father or guardian</p>
                </div>
              </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                  ...
                  <input
                    v-model="formData.fatherNationalId"
                    type="text"
            ...
            <div v-show="currentStep === 4" class="p-8">
              <div class="flex items-center mb-6">
                <div class="w-10 h-10 bg-gradient-to-r from-pink-500 to-rose-600 rounded-full flex items-center justify-center mr-4">
                  <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                  </svg>
                </div>
                <h2 class="text-2xl font-bold text-gray-800">Mother Information</h2>
              </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                  ...
                  <input
                    v-model="formData.motherNationalId"
                    type="text"
              ...
              <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-4">
                  <button
                    type="button"
                    @click="resetForm"
                    class="flex items-center px-6 py-3 bg-orange-500 text-white rounded-xl hover:bg-orange-600 focus:outline-none focus:ring-4 focus:ring-orange-200 transition-all duration-300"
                  >
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
